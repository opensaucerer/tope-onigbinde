                ...
                if ('string' === n)
                  ...
                  (void 0 !== t && 'boolean' !== n) ||
                    ...
                    this.setAttribute &&
                      this.setAttribute(
                        'class',
                        e || !1 === t ? '' : jt.get(this, '__className__') || ''
                      ));
              });
        },
        hasClass: function (t) {
        ...
        t.each(function (t, n) {
          for (
            var i = u()(n),
              ...
              a = i.data('id'),
              s = i.find('.js-submit'),
              c = s.find('.js-submit-text'),
              f = new y.a(e._spinnerOpts),
              h = Object.entries(d.a.localizedValidationMessages),
              g = 0;
            g < h.length;
            g++
          ) {
          ...
          var _ = p.a
            .extend({
              ...
              commit: function (t) {
                return (
                  (t.url = '/site/forms/' + l.a.page_id + '/' + a + '/'), this
                );
              },
            })
            .init(o);
          _.on({
            'error:show': function (t, e) {
              t.parent().addClass('error').find('.form-error').remove(),
                t.after(
                  '<div class="js-form-error form-error">' + e + '</div>'
                );
            },
      ...
      init: function () {
        ...
        if (e && !u) {
          ...
          if (
            ...
            var v = a.a.get('cookie_consent');
            if (('1' === v && s.a.init(o), null !== v)) return;
            l.on('click', function () {
